 ...
 */
package main.java.com.careHubApps.view.antrian;
...
import main.java.com.careHubApps.view.HomePanel;
...
public final class AntrianView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mainPanel.setMinimumSize(new java.awt.Dimension(1160, 720));
    ...
    private void displayQueues(List<AntrianModel> queues) {
        ...
        if (queues == null || queues.isEmpty()) { 
            ...
            int cardWidth = 320, cardHeight = 400;
            int padding = 20;
            ...
            for (AntrianModel antrian : queues) {
                ...
                JLabel labelLayanan = new JLabel(antrian.getLayanan());
                JLabel titleDokter = new JLabel("Dokter");
                JLabel labelDokter = new JLabel(antrian.getDokter());
                ...
                cardAntrian.add(titleDokter, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, -1, -1));
                cardAntrian.add(labelDokter, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 220, -1, -1));
                cardAntrian.add(titleRuang, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 250, -1, -1));
                cardAntrian.add(labelRuang, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 270, -1, -1));
                cardAntrian.add(buttonAntrian, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 330, -1, -1));
