 ...
 * @author ASUS
 */
public class EditDokterView extends javax.swing.JFrame {
     ...
     */
    public EditDokterView(DokterModel dokter) {
        initComponents();
    ...
    private void initComponents() {
        ...
        txtFieldNamaDokter.setEditable(false);
        ...
        titleDataObat.setText("Edit Data Dokter");
    ...
    private void simpanButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_simpanButtonMouseClicked
        ...
        dokterModel = new DokterModel(dokterModel.getId(), namaDokter, spesialis, telpon, alamat);
        boolean isUpdated = dokterController.updateDokter(dokterModel);
    ...
    private void loadData(DokterModel dokter) {
        txtFieldNamaDokter.setText(dokter.getNama());
        txtFieldTelpon.setText(dokter.getNoTelpon());
        txtFieldAlamat.setText(dokter.getAlamat());
        comboSpesialis.setSelectedItem(dokter.getSpesialis());
    }
